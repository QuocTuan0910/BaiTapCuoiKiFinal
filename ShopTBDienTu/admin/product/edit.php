        ...
        <div class="row">
            <div class="col-md-12">
                ...
                if (isset($_POST['submit'])) {
                    ...
                    if ($name != "" && $danhmucsp != "") {
                        $sql = "UPDATE tbl_sanpham SET sanpham_name = '$name' , id_menu = '$danhmucsp', sanpham_gia = '$sanpham_gia', sanpham_giakhuyenmai = '$sanpham_km', sanpham_soluong = '$sanpham_sl', sold_number = '$sold_num', sanpham_des = '$review' ,sanpham_image = '$newFilename'  WHERE sanpham_id = $sanpham_id";
