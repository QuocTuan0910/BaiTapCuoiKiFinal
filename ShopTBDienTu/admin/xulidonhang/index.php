...
<div id="page-wrapper">
    <div id="page-inner">
        <?php 
            if(isset($_GET['id'])){
                $result_huy = mysqli_query($mysqli, "UPDATE orders SET yeucauhuy = '1' WHERE id = {$_GET['id']}");
            }
        ?>
                            ...
                            <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                ?>
                                        <tr class="<?php echo $cl ?> gradeX">
                                            ...
                                            <td>
                                                <?php 
                                                    if($arOrders['tinhtrang'] == '1'){
                                                        echo "Đã xử lí";
                                                    }elseif($arOrders['tinhtrang'] == '0'){
                                                        echo "Chưa xử lí";
                                                    }
                                                ?>
                                            </td>
                                            <td>
                                            <?php 
                                                if($arOrders['yeucauhuy'] == '2'){
                                                    echo '<a style="font-size: 14px" href="admin/xulidonhang/index.php?id='.$arOrders['id'].'">Xác nhận y/c hủy</a>';
                                                }elseif($arOrders['yeucauhuy'] == '1'){
                                                    echo 'Đã hủy';
                                                }else{
                                            ...
                                            <td><a href="admin/xulidonhang/del_dh.php?id=<?php echo $arOrders['id']; ?>" id="<?php echo $arOrders['id']; ?>" class="btn btn-danger delete"><i class="fa fa-pencil"></i> Del</a></td>
                                        </tr>
                                    <?php
                                    }
                                    ?>
