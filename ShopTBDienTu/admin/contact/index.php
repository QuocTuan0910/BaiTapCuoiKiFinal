...
<div id="page-wrapper">
    <div id="page-inner">
        <?php
        $row_count = 4;
        $query1 = mysqli_query($mysqli, "SELECT * FROM contact");
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr class="<?php echo $cl ?> gradeX">
                                            ...
                                            <td><?php echo $arUser['subject'] ?></td>
                                            <td><?php echo $arUser['message'] ?></td>
                                            <td class="center">
                                            <?php if(checkPrivilege('contact_del.php?id=0')) { ?>
                                                <a href="admin/contact/del.php?id=<?php echo $arUser['id'] ?>" onclick="return confirm ('Ban co that muon xoa binh luan nay khong ?')" title="" class="btn btn-danger"><i class="fa fa-pencil"></i> Xóa</a>
                                                <?php } ?>
                                            </td>
                                        </tr>
                                    <?php
                                ...
                                <div class="col-sm-6" style="text-align: right;">
                                    <div class="dataTables_paginate paging_simple_numbers" id="dataTables-example_paginate">
                                        <ul class="pagination">
                                            ...
                                            ?>
                                                <li class="paginate_button <?php echo $active; ?>" aria-controls="dataTables-example" tabindex="0"><a href="admin/contact/index.php?page=<?php echo $i; ?>"><?php echo $i; ?></a></li>
                                            <?php
                                            }
                                            ?>
                                        </ul>
