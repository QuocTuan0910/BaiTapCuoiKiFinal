															...
															<div class="wrap-price">
																<div class="price-box">
																	...
																	?>
																		...
																		<div class="buy-button">
																		<form class="quick-buy-form" action="cart.php?action=add" method="POST">
																			<input type="hidden" value="1" name='quantity[<?php echo $row_new_arrivals['sanpham_id']; ?>]'>
																			<input style="padding: 10px;margin-left: 45px;background-color:gold" type="submit" value="Mua ngay">
																		</form>
																	</div>
															...
															<div class="wrap-price">
																<div class="price-box">
																	...
																	?>
																		...
																		<div class="buy-button">
																		<form class="quick-buy-form" action="cart.php?action=add" method="POST">
																			<input type="hidden" value="1" name='quantity[<?php echo $row_ppl['sanpham_id']; ?>]'>
																			<input style="padding: 10px;margin-left: 45px;background-color:gold" type="submit" value="Mua ngay">
																		</form>
																	</div>
																	<?php
															...
															<div class="wrap-price">
																<div class="price-box">
																	...
																	?>
																		...
																		<div class="buy-button">
																		<form class="quick-buy-form" action="cart.php?action=add" method="POST">
																			<input type="hidden" value="1" name='quantity[<?php echo $row_special['sanpham_id']; ?>]'>
																			<input style="padding: 10px;margin-left: 45px;background-color:gold" type="submit" value="Mua ngay">
																		</form>
																	</div>
