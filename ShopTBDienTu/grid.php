					...
					<li class="col-lg-3 col-md-3 col-sm-6 col-xs-12 item">
						<div class="item-wrap">
							<div class="item-image">
								...
								<a title="Add to cart" class="btn-cart" onclick="addCart(<?php echo $row2['sanpham_id']; ?>);" >&nbsp;</a>
							</div>
							<div class="pro-info">
								<div class="pro-inner">
									<?php
									$id_detail = $row2['sanpham_id'];
									$name = $row2['sanpham_name'];
									$nameReplace = utf8ToLatin($name);
									$url2 = $nameReplace . '-' . $id_detail;
									?>
									<div class="pro-title product-name"><a href="<?php echo $url2 . '.html'; ?>"><?php echo $row2['sanpham_name']; ?></a></div>
